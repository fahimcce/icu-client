...
const AllDiagnostic = () => {
    ...
    const [alllabs, setAllLabs] = useState(labs);
    ...
    useEffect(() => {
        setAllLabs(labs); // Reset all labs when the data changes
    }, [labs]);
    ...
    return (
        <div className='mb-4'>
            <h1 className='text-3xl text-center font-semibold text-green-600'>
                <i className='fas fa-hand-point-right mx-2'></i>Lab Test Prices
            </h1>
            <hr />
            <div>
                    ...
                    <table className='table'>
                        ...
                        <tbody>
                            {isLoading ? (
                                ...
                                (filteredLabs.length > 0 ? filteredLabs : alllabs).map((lab, index) => (
                                    <tr
                                    ...
                                    >
                                        ...
                                        <td className='text-center' style={{ marginBottom: '1rem' }}>
                                            {lab.price}
                                        </td>
                                        {isAdmin && (
                                            <td>
                                                <Link className='mx-2' to={`/update/lab/${lab._id}`}>
